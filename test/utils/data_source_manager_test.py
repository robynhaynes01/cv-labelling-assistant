def test_source_manager_conversion_to_standard_format():
    ...
    assert standard_format._bboxes[0].get('bbox') == [142.58064516129033, 126.0215053763441, 444.73118279569894, 331.39784946236557]
...
def test_source_manager_conversion_from_standard_format():
    ...
    standard_format.add_bbox([142.58064516129033, 126.0215053763441, 444.73118279569894, 331.39784946236557], "test")
    ...
    assert shape.get('points') == [[142.58064516129033, 126.0215053763441], [444.73118279569894, 331.39784946236557]]
    print(labelme_data)